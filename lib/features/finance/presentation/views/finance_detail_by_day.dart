...
class FinanceDetailByDay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final financeOverviewBloc = getIt.get<FinanceOverviewBloc>();
...
class _FinanceDetailByDayItem extends StatelessWidget {
  const _FinanceDetailByDayItem({required this.dailyBreakdown});
...
class _FinanceDetailIcon extends StatelessWidget {
  const _FinanceDetailIcon({
    required this.asset,
    required this.color,
    required this.backgroundColor,
