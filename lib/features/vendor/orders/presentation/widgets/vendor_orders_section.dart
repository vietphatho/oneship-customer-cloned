part of '../views/vendor_orders_page.dart';
    ...
    return Column(
      ...
      children: [
        ...
        IndexedStack(
          ...
          children: const [
            _OrdersTabBody(tab: VendorOrdersTab.processing),
            _OrdersTabBody(tab: VendorOrdersTab.archived),
          ],
        ),
      ],
    );
...
class _OrderList extends StatelessWidget {
  ...
  final VendorOrdersTab tab;
  final VendorOrdersState state;

  @override
  Widget build(BuildContext context) {
    final resource = switch (tab) {
      VendorOrdersTab.processing => state.processingOrdersResource,
      VendorOrdersTab.archived => state.archivedOrdersResource,
    };
    final orders = switch (tab) {
      VendorOrdersTab.processing => state.processingOrders,
      VendorOrdersTab.archived => state.archivedOrders,
    };
