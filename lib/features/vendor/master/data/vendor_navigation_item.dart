...
import 'package:oneship_customer/features/vendor/wallet/presentation/views/vendor_wallet_page.dart';

enum VendorNavigationItem { home, orders, wallet, profile }
...
extension VendorNavigationItemExt on VendorNavigationItem {
  static const _mapTitle = {
    ...
    VendorNavigationItem.wallet: 'vendor_master.wallet',
  ...
  static const _mapIcon = {
    ...
    VendorNavigationItem.wallet: SvgPath.wallet,
  ...
  static const _mapPage = {
    ...
    VendorNavigationItem.wallet: VendorWalletPage(),
