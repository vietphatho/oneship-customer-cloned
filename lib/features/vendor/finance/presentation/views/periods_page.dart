...
import 'package:oneship_customer/features/vendor/finance/presentation/widgets/finance_period_card.dart';
...
class PeriodsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bloc = getIt.get<VendorFinanceReconciliationBloc>();
    return MultiBlocListener(
      listeners: [
        ...
        >(
          ...
          listener: _handleChangeSettlementStatus,
        ),
        BlocListener<
          VendorFinanceReconciliationBloc,
          VendorFinanceReconciliationState
              ...
              return ColoredBox(
                ...
                child: Column(
                  children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          PopupMenuButton<SettlementStatus>(
                            ...
                            onSelected: bloc.changedSettlementStatus,
                            position: PopupMenuPosition.under,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(12),
                            ),
                            itemBuilder: (context) => SettlementStatus.values
                                .map(
                    ...
                    Expanded(
                      child: state.periodsData.isEmpty
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return VendorFinancePeriodCard(
                                  periodEntity: period,
                                  onTap: () {
  ...
  static String _statusFilterText(SettlementStatus status) {
    return switch (status) {
      SettlementStatus.all => 'status_all'.tr(),
      SettlementStatus.open => 'status_open'.tr(),
      SettlementStatus.locked => 'status_locked'.tr(),
      SettlementStatus.approved => 'status_approved'.tr(),
      SettlementStatus.cancelled => 'status_cancelled'.tr(),
    };
  }

  void _handleChangeSettlementStatus(
    BuildContext context,
    VendorFinanceReconciliationState state,
  ) {
  ...
  void _handleFetchPeriodDetail(
    ...
    switch (state.periodDetailEntity.state) {
      ...
      case Result.success:
        PrimaryDialog.hideLoadingDialog(context);
        context.push(RouteName.vendorFinancePeriodDetailPage);
      case Result.error:
        PrimaryDialog.hideLoadingDialog(context);
        PrimaryDialog.showErrorDialog(context);
    }
