...
class CommoditySelectionPage extends StatelessWidget {
  CommoditySelectionPage({super.key});
        ...
        return BlocBuilder<CreateOrderBloc, CreateOrderState>(
          ...
          builder: (context, orderState) {
            return OrderOptionSelectionContent(
              title: "commodity_type".tr(),
              resource: shopState.commodityTypesResource,
              selectedCodes:
                  orderState.draftRequest.detail?.commodityType ?? const [],
              onToggle: _createOrderBloc.toggleCommodityType,
            );
          },
        );
      },
