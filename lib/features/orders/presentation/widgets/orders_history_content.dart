              ...
              child: TabBarView(
                ...
                children: [
                  OrdersHistoryListCard(
                    ...
                    onRefresh: () => _ordersBloc.fetchOrderHistory(
                      OrderStatus.allProcessing,
                    ),
                    onLoadMore: () => _ordersBloc.loadMoreOrderHistory(
                      OrderStatus.allProcessing,
                    ),
                  ...
                  OrdersHistoryListCard(
                    ...
                    onLoadMore: () =>
                        _ordersBloc.loadMoreOrderHistory(OrderStatus.delivered),
                    onOrderTap: _onOrderTap,
                    isLoading: widget.isLoadingFor(
                  ...
                  OrdersHistoryListCard(
                    ...
                    onLoadMore: () =>
                        _ordersBloc.loadMoreOrderHistory(OrderStatus.returned),
                    onOrderTap: _onOrderTap,
