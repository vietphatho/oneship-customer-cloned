...
class _DelayedOrdersListViewState extends State<DelayedOrdersListView> {
  ...
  void initState() {
    super.initState();
    _ordersBloc.currentOrderStatus = OrderStatus.delayed;
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      ...
      child: BlocBuilder<OrdersBloc, OrdersState>(
        bloc: _ordersBloc,
        buildWhen: (pre, cur) => pre.delayedOrdersList != cur.delayedOrdersList || pre.processingOrdersFilters != cur.processingOrdersFilters,
        builder: (context, state) {
          List<OrderInfo> orders = sortOrders(state.filteredDelayedOrdersList, _sortOption);
  ...
  void _listenOrdsListChanged(BuildContext context, OrdersState state) {
    final visibleOrderKeys = state.filteredDelayedOrdersList.map(_orderKey).whereType<String>().toSet();
