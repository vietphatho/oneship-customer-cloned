...
import 'package:oneship_shop/features/orders/data/models/response/products_list_response.dart';
...
abstract class OrdersApi {
  ...
  @PATCH("/api/v1/orders/{ordId}")
  Future<BaseResponse> updateOrder({
    @Path("ordId") required String ordId,
  ...
  @POST("/api/v1/hub/{hubId}/verify")
  Future<BaseResponse> validateOrdAtHub({
